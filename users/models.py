...
class User(AbstractUser):
    ...
    language = models.CharField(
        _('language'), choices=LANGUAGE_CHOICES, max_length=2, blank=True)
    currency = models.CharField(
        _('currency'), choices=CURRENCY_CHOICES, max_length=3, blank=True)
    ...
    objects = common_managers.CustomModelManager()
